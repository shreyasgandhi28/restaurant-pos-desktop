...
<div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6">
    ...
    <div class="grid grid-cols-1 lg:grid-cols-2 gap-6">
        ...
        <div class="bg-white rounded-lg shadow overflow-hidden flex flex-col h-full">
            ...
            <form action="{{ route('settings.profile.update') }}" method="POST" class="p-6 flex flex-col h-full">
                @csrf
                @method('PUT')
                ...
                <div class="space-y-4 flex-1">
                    ...
                    <div>
                        ...
                        <input type="text" value="{{ ucfirst(auth()->user()->roles->first()->name ?? 'User') }}" disabled
        ...
        <div class="bg-white rounded-lg shadow overflow-hidden flex flex-col h-full">
            ...
            <form action="{{ route('settings.password.update') }}" method="POST" class="p-6 flex flex-col h-full">
                @csrf
                @method('PUT')
                ...
                <div class="space-y-4 flex-1">
                    <div>
                        ...
                        <input type="password" name="current_password" required
                               class="mt-1 block w-full py-2 px-3 border border-gray-300 bg-white rounded-md shadow-sm focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 @error('current_password') border-red-500 @enderror">
                    ...
                    <div>
                        ...
                        <input type="password" name="password" required
                               class="mt-1 block w-full py-2 px-3 border border-gray-300 bg-white rounded-md shadow-sm focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 @error('password') border-red-500 @enderror">
                        @error('password')
                            <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                        @enderror
    ...
    <div class="mt-6">
        ...
        <div class="bg-white rounded-lg shadow lg:col-span-2 mb-6">
            ...
            <div class="p-6">
                ...
                <div class="mt-4">
                    <a href="{{ route('settings.users.index') }}" class="inline-flex items-center px-4 py-2 border border-transparent text-sm font-medium rounded-md shadow-sm text-white bg-indigo-600 hover:bg-indigo-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500">
        ...
        <div class="bg-white rounded-lg shadow lg:col-span-2">
            ...
            <form action="{{ route('settings.app.update') }}" method="POST" class="p-6">
                @csrf
                @method('PUT')
                ...
                <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                    <div>
                        ...
                        <input type="text" name="restaurant_name"
                               value="{{ old('restaurant_name', $settings['restaurant_name']->value ?? 'Restaurant POS') }}"
                               required
                               class="mt-1 block w-full py-2 px-3 border border-gray-300 bg-white rounded-md shadow-sm focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 @error('restaurant_name') border-red-500 @enderror">
                    ...
                    <div>
                        ...
                        <input type="number" name="tax_rate" step="0.01" min="0" max="100"
                               ...
                               required
                               class="mt-1 block w-full py-2 px-3 border border-gray-300 bg-white rounded-md shadow-sm focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 @error('tax_rate') border-red-500 @enderror">
                        @error('tax_rate')
                            <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                        @enderror
                        <p class="mt-1 text-xs text-gray-500">Current: {{ $settings['tax_rate']->value ?? 10 }}%</p>
                    </div>
                    ...
                    <div>
                        ...
                        <input type="number" name="service_charge_rate" step="0.01" min="0" max="100"
                               value="{{ old('service_charge_rate', $settings['service_charge_rate']->value ?? 5) }}"
                               required
                               class="mt-1 block w-full py-2 px-3 border border-gray-300 bg-white rounded-md shadow-sm focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 @error('service_charge_rate') border-red-500 @enderror">
                        @error('service_charge_rate')
                            <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                        @enderror
                        <p class="mt-1 text-xs text-gray-500">Current: {{ $settings['service_charge_rate']->value ?? 5 }}%</p>
                    </div>
                    ...
                    <div class="p-6">
                        <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                            ...
                            <div>
                                ...
                                <input type="text" name="gst_number"
                                       value="{{ old('gst_number', $settings['gst_number']->value ?? '') }}"
                                       class="mt-1 block w-full py-2 px-3 border border-gray-300 bg-white rounded-md shadow-sm focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 @error('gst_number') border-red-500 @enderror"
                            ...
                            <div>
                                ...
                                <input type="tel" name="primary_phone" required
                                       value="{{ old('primary_phone', $settings['primary_phone']->value ?? '') }}"
                                       class="mt-1 block w-full py-2 px-3 border border-gray-300 bg-white rounded-md shadow-sm focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 @error('primary_phone') border-red-500 @enderror"
                            ...
                            <div>
                                ...
                                <input type="tel" name="secondary_phone"
                                       value="{{ old('secondary_phone', $settings['secondary_phone']->value ?? '') }}"
                                       class="mt-1 block w-full py-2 px-3 border border-gray-300 bg-white rounded-md shadow-sm focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 @error('secondary_phone') border-red-500 @enderror"
                                       placeholder="e.g. +91 9876543210">
                        ...
                        <div class="mt-6">
                            ...
                            <textarea name="business_address" rows="2"
                                class="mt-1 block w-full py-2 px-3 border border-gray-300 bg-white rounded-md shadow-sm focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 @error('business_address') border-red-500 @enderror"
                                placeholder="Enter full business address">{{ old('business_address', $settings['business_address']->value ?? '') }}</textarea>
