...
<div style="font-size: 12px; margin: 5px 0;">
    <div style="display: flex; justify-content: space-between; margin: 3px 0;">
        ...
        <span style="font-weight: bold;"><?php echo e(strtoupper($bill->payment_method ?? 'CASH')); ?></span>
    </div>
    <div style="display: flex; justify-content: space-between; margin: 3px 0;">
        <span>Amount Paid:</span>
        <span style="font-weight: bold;">₹<?php echo e($bill->status === 'paid' ? number_format($bill->total_amount, 2) : '0.00'); ?></span>
    </div>
    <?php if($bill->paid_at): ?>
        <div style="display: flex; justify-content: space-between; margin: 3px 0;">
            <span>Paid At:</span>
            <span><?php echo e($bill->paid_at->format('d/m/Y h:i A')); ?></span>
        </div>
    <?php endif; ?>
</div>
