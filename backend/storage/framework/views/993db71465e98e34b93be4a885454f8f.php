...
<div class="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8">
    ...
    <div class="bg-white rounded-lg shadow p-6">
        <form action="<?php echo e(route('menu-items.update', $menuItem)); ?>" method="POST" enctype="multipart/form-data">
            <?php echo csrf_field(); ?>
...
unset($__errorArgs, $__bag); ?>"
                              placeholder="Brief description of the item"><?php echo e(old('description', $menuItem->description)); ?></textarea>
...
unset($__errorArgs, $__bag); ?>
                ...
                <div>
                    <label for="image" class="block text-sm font-medium text-gray-700 mb-2">
                        <?php echo e($menuItem->image ? 'Replace Image' : 'Upload Image'); ?>
...
unset($__errorArgs, $__bag); ?>
    ...
    <div class="mt-6 bg-blue-50 border border-blue-200 rounded-lg p-4">
        ...
        <div class="text-sm text-blue-800 space-y-1">
            <p><strong>Created:</strong> <?php echo e($menuItem->created_at->format('M d, Y h:i A')); ?></p>
            <p><strong>Last Updated:</strong> <?php echo e($menuItem->updated_at->format('M d, Y h:i A')); ?></p>
        </div>
    </div>
    
    <!-- Hidden form for image removal -->
    <?php if($menuItem->image): ?>
        <form id="remove-image-form" action="<?php echo e(route('menu-items.update', $menuItem)); ?>" method="POST" style="display: none;">
            <?php echo csrf_field(); ?>
            <?php echo method_field('PUT'); ?>
            <input type="hidden" name="category_id" value="<?php echo e($menuItem->category_id); ?>">
            <input type="hidden" name="name" value="<?php echo e($menuItem->name); ?>">
            <input type="hidden" name="description" value="<?php echo e($menuItem->description); ?>">
            <input type="hidden" name="price" value="<?php echo e($menuItem->price); ?>">
            <input type="hidden" name="is_available" value="<?php echo e($menuItem->is_available ? '1' : '0'); ?>">
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\restaurant-pos-desktop\backend\resources\views/menu-items/edit.blade.php ENDPATH**/ ?>