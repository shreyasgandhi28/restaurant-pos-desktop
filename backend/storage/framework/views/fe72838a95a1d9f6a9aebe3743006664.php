...
<div class="flex justify-end space-x-1">
    ...
    <?php elseif($order->bill): ?>
        ...
        <a href="javascript:void(0)" 
           onclick="if(window.electronAPI) { window.electronAPI.openExternal('<?php echo e(URL::signedRoute('bills.print', $order->bill)); ?>'); } else { window.open('<?php echo e(URL::signedRoute('bills.print', $order->bill)); ?>', '_blank'); }"
           title="Print"
