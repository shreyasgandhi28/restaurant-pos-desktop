                        ...
                        <div class="menu-item bg-white border border-gray-200 rounded-lg p-2 cursor-pointer hover:border-indigo-500 hover:shadow-sm transition flex flex-col" 
                            ...
                            <div class="mt-3">
                                <div class="flex justify-between items-end">
                                    <h4 class="text-xs font-medium text-gray-900 truncate pr-2"><?php echo e($item->name ?? 'Unnamed Item'); ?></h4>
                                    <p class="text-xs font-bold text-indigo-600 whitespace-nowrap">₹<?php echo e(number_format($item->price ?? 0, 0)); ?></p>
                                </div>
                            </div>
                        </div>
                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
